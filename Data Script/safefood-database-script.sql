...
CREATE TABLE SafeFood_Comentario_Produto(
	FkConsumidor CHAR(36) NOT NULL,
	FkProduto CHAR(36)  NOT NULL,
...
insert into SafeFood_Usuario values('72fe51df-359d-42f-9b46-c40d3f45714c', 'Angolas', 'angolano@gmail.com', CONVERT(VARCHAR(20), HASHBYTES('md5', '23564')), '+55 (11)967584657', 1, null);
...
insert into SafeFood_Usuario values ('72fe51df-359d-42f-9b46-c40d3f457967', 'Vinicius Soares de Souza', 'vinicius@gmail.com', CONVERT(VARCHAR(20), HASHBYTES('md5', '12345')), '+55 (11)976964512', 0, null);
...
DELETE FROM SafeFood_Rate;
DELETE FROM SafeFood_Comentario_Produto;
...
SELECT * FROM SafeFood_Comentario_Produto;
SELECT * FROM SafeFood_Rate;
...
DROP TABLE SafeFood_Comentario_Produto;
DROP TABLE SafeFood_Rate;
